...
def test_read_value_():
    country = football_stats.get("Страна")
...
def test_read_dict():
    total_goals = football_stats["Награды"]["Больше всего голов"][
        "Количество мячей"]
...
# Метод get более "мягкий", если в словаре ничего не найдено,
...
# Метод get может принимать второе значение, если ничего не найдешь,
# то запиши в него, например "abc123"
